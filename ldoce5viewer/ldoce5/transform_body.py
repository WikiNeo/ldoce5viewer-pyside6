...
def _trans_assets(root):
    ...
    if "entry_collocations" in assets:
        colloc.append(("This Entry", "/collocations/" + assets["entry_collocations"]))
    if "other_entries_collocations" in assets:
        colloc.append(
            ("Other Entries", "/collocations/" + assets["other_entries_collocations"])
        )
    if "corpus_collocations" in assets:
        colloc.append(("Corpus", "/collocations/" + assets["corpus_collocations"]))
    if "thesaurus" in assets:
        thesaurus.append(("Thesaurus", "/thesaurus/" + assets["thesaurus"]))
    if "activator" in assets:
        thesaurus.append(("Activator", "/thesaurus/" + assets["activator"]))
    if "word_sets" in assets:
        thesaurus.append(("Word Set", "/word_sets/" + assets["word_sets"]))
    if "other_dictionary_examples" in assets:
        example.append(
            ("Other Dicts", "/examples/" + assets["other_dictionary_examples"])
        )
    if "corpus_examples" in assets:
        example.append(("Corpus", "/examples/" + assets["corpus_examples"]))
    if "entry_phrases" in assets:
        phrase.append(("This Entry", "/phrases/" + assets["entry_phrases"]))
    if "other_entries_phrases" in assets:
        phrase.append(("Other Entries", "/phrases/" + assets["other_entries_phrases"]))
    if "word_families" in assets:
        word.append(("Family", "/word_families/" + assets["word_families"]))
    if "etymology" in assets:
        word.append(("Origin", "/etymologies/" + assets["etymology"]))
